...
public:
    ...
    image_listener() {
        ...
        //for real
//        cameraMatrix.ptr<float>(0)[0] = 519.825239f;   // fx
//        cameraMatrix.ptr<float>(0)[1] = 0.000000f;     // 0
//        cameraMatrix.ptr<float>(0)[2] = 425.092033f;   // cx
//        cameraMatrix.ptr<float>(1)[0] = 0.000000f;     // 0
//        cameraMatrix.ptr<float>(1)[1] = 510.638691f;    // fy
//        cameraMatrix.ptr<float>(1)[2] = 232.817398f;    // cy
//        cameraMatrix.ptr<float>(2)[0] = 0.000000f;     // 0
//        cameraMatrix.ptr<float>(2)[1] = 0.000000f;     // 0
//        cameraMatrix.ptr<float>(2)[2] = 1.000000f;     // 1

//        distCoeffs.ptr<float>(0)[0] = -0.017701;         // k1
//        distCoeffs.ptr<float>(0)[1] = 0.002241;         // k2
//        distCoeffs.ptr<float>(0)[2] =-0.001883;         // p1
//        distCoeffs.ptr<float>(0)[3] = 0.000525;         // p2
//        distCoeffs.ptr<float>(0)[4] = 0.0;              // k2
    ...
    void imageCallback(const sensor_msgs::ImageConstPtr& msg)
    {
        ...
        if (ids.size() > 0) {
            ...
            //for simulation size is 0.13 for real 0.175
