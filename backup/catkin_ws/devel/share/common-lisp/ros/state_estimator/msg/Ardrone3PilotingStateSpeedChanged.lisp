...
(cl:defmethod cl:initialize-instance :after ((m <Ardrone3PilotingStateSpeedChanged>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Ardrone3PilotingStateSpeedChanged)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name state_estimator-msg:<Ardrone3PilotingStateSpeedChanged> is deprecated: use state_estimator-msg:Ardrone3PilotingStateSpeedChanged instead.")))
...
(cl:defmethod speedX-val ((m <Ardrone3PilotingStateSpeedChanged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_estimator-msg:speedX-val is deprecated.  Use state_estimator-msg:speedX instead.")
  (speedX m))

(cl:ensure-generic-function 'speedY-val :lambda-list '(m))
(cl:defmethod speedY-val ((m <Ardrone3PilotingStateSpeedChanged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_estimator-msg:speedY-val is deprecated.  Use state_estimator-msg:speedY instead.")
  (speedY m))

(cl:ensure-generic-function 'speedZ-val :lambda-list '(m))
(cl:defmethod speedZ-val ((m <Ardrone3PilotingStateSpeedChanged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_estimator-msg:speedZ-val is deprecated.  Use state_estimator-msg:speedZ instead.")
  (speedZ m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Ardrone3PilotingStateSpeedChanged>)))
  ...
  "state_estimator/Ardrone3PilotingStateSpeedChanged")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Ardrone3PilotingStateSpeedChanged)))
  "Returns string type for a message object of type 'Ardrone3PilotingStateSpeedChanged"
  "state_estimator/Ardrone3PilotingStateSpeedChanged")
